...
public class TAImportDepartements extends AsyncTask<String, Integer, String> {
    ...
    public TAImportDepartements() {

    }

    public TAImportDepartements(Context contexte, TextView tv, String psBD, String psTable) {
    ...
    protected void onPostExecute(String s) {
        ...
        DAOGenerique.insertDepartements("cinescope2017", "departement", s);
